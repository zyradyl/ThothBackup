...
if [ ! -f $FIRST_RUN ]; then
  ...
  printf "\n\n\nWARNING:\n"
  printf "You must now allow Thoth-Backup Full Disk Access. In a moment, a\n"
  ...
  printf "4. Drag the Thoth-Backup program from applications into FDA\n"
  printf "5. Make sure Thoth-Backup is checked\n"
